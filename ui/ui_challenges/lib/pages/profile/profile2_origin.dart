...
import 'package:ui_challenges/widgets/network_image.dart';

class ProfileTwoOriginPage extends StatelessWidget {
  static const String path = "lib/pages/profile/profile2_origin.dart";
  static const String imageUrl =
      'https://firebasestorage.googleapis.com/v0/b/dl-flutter-ui-challenges.appspot.com/o/img%2F7.jpg?alt=media';
  final List<Map> collections = [
    {"title": "Food joint", "image": imageUrl},
    {"title": "Photos", "image": imageUrl},
    {"title": "Travel", "image": imageUrl},
    {"title": "Nepal", "image": imageUrl},
  ];

  ProfileTwoOriginPage({super.key});
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          ListView.builder(itemCount: 7, itemBuilder: _mainListBuilder),
        ],
      ),
    );
  }
  ...
  Widget _buildListItem() {
    return Container(
      ...
      child: ClipRRect(
        ...
        child: PNetworkImage(imageUrl[2], fit: BoxFit.cover),
      ),
    );
  }
            ...
            children: <Widget>[
              Material(
                ...
                child: CircleAvatar(
                  radius: 40.0,
                  backgroundImage:
                      const AssetImage('assets/avatar/avatar0.jpg'),
                ),
              ),
            ],
          ),
