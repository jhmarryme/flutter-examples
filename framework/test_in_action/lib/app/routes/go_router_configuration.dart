                ...
                GoRoute(
                  ...
                  routes: [
                    ...
                    GoRoute(
                      ...
                      builder: (context, state) => const EmailSendCodeView(),
                    ),
                    GoRoute(
                      redirect: authRedirect,
                      name: ProfileRouterDefine.profileSettingPhone.name,
                      path: ProfileRouterDefine.profileSettingPhone.path,
                      builder: (context, state) => const PhoneSendCodeView(),
                    ),
                  ],
                ),
              ],
