...
class NestedScrollViewView extends StatefulWidget {
  const NestedScrollViewView({Key? key}) : super(key: key);

  @override
  NestedScrollViewViewState createState() {
    return NestedScrollViewViewState();
  }
}

class NestedScrollViewViewState extends State<NestedScrollViewView>
    with SingleTickerProviderStateMixin {
  late TabController _tabController;
  int _tabIndex = 0;
  int _listCount = 20;
  final int _gridCount = 20;
