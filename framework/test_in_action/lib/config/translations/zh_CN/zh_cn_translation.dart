...
const Map<String, String> zhCnTheme = {
  ThemeStrings.themeMode: '主题模式',
  ThemeStrings.hint: '选择主题',
  ThemeStrings.system: '跟随系统',
  ThemeStrings.dark: '深色模式',
  ThemeStrings.light: '浅色模式',
};

const Map<String, String> zhCnLanguage = {
  LanguageStrings.language: '语言',
