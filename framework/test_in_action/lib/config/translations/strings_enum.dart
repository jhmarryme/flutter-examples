...
class ThemeStrings {
  static const String prefix = "ThemeStrings.";
  static const String themeMode = "${prefix}themeMode";
  static const String hint = "${prefix}hint";
  static const String system = "${prefix}system";
  static const String dark = "${prefix}dark";
  static const String light = "${prefix}light";
}

class LanguageStrings {
  static const String prefix = "LanguageStrings.";
  static const String language = "${prefix}language";
  static const String zhCn = "${prefix}zhCn";
  static const String enUs = "${prefix}enUs";
}
