...
// import 'package:in_action/utils/device_utils.dart';
// import 'package:in_action/utils/log_utils.dart';
// import 'package:in_action/utils/other_utils.dart';
...
//         SpUtil.getString(SysConstant.accessToken).nullSafe;
...
//         SpUtil.getString(SysConstant.refreshToken).nullSafe;
//     try {
//       _tokenDio ??= Dio();
...
//       response.statusCode = ExceptionHandle.success as int?;
//     } else {
...
//             if (response.statusCode == ExceptionHandle.unauthorized) {
//               response.statusCode = ExceptionHandle.unauthorized as int?;
//             } else {
//               response.statusCode = ExceptionHandle.success as int?;
//             }
//           } catch (e) {
