...
final GlobalKey<NavigatorState> _homeANavigatorKey =
      ...
      StatefulShellRoute.indexedStack(
        ...
        branches: <StatefulShellBranch>[
          ...
          StatefulShellBranch(
            routes: [
              ShellRoute(
                navigatorKey: _homeANavigatorKey,
                          ...
                          child: Scaffold(
                            body: Row(
                              children: [
                                TextButton(
                                    onPressed: () =>
                                        GoRouter.of(context).go('/detail1'),
                                    child: Text("to detail1")),
                                TextButton(
                                    onPressed: () =>
                                        GoRouter.of(context).go('/detail2'),
                                    child: Text("to detail2")),
                                TextButton(
                                    onPressed: () =>
                ...
                routes: [
                  GoRoute(
                    path: '/detail1',
                    builder: (BuildContext context, GoRouterState state) => Row(
                      children: [
                        Expanded(
                            child: DetailsScreen(
                          label: 'detail1',
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const <BottomNavigationBarItem>[
          ...
          BottomNavigationBarItem(icon: Icon(Icons.adb), label: 'Section D'),
        ],
