    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            RoundedInput(hintText: "Name", onSubmit: (value) => print(value)),
            SizedBox(height: 16),
            RoundedInput(hintText: "Color", onSubmit: (value) => print(value)),
            SizedBox(height: 16),
            RoundedInput(
                hintText: "Location", onSubmit: (value) => print(value)),
            SizedBox(height: 16),
            TextButton(
